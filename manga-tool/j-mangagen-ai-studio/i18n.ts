...
export let translations = {
  en: {
    ...
    tip4: "English manga renders text more cleanly with Gemini 2.5 Flash Image. Consider English prompts for best results.",
    ...
    modelHigh: "Gemini 3 Pro Image (High Quality, Paid)",
    modelFast: "Gemini 2.5 Flash Image (Fast, Free Tier)",
    modelHighDesc: "Best for Japanese text. Paid only.",
    modelFastDesc: "Good for English. Free tier available.",
  ...
  ja: {
    ...
    tip4: "英語圏向けマンガは Gemini 2.5 Flash Image でも文字が崩れにくく品質が出やすいです。プロンプトを英語で記述することを推奨します。",
    poweredBy: "Powered by Gemini 3.0 / 2.5 Flash",
    ...
    // Model Selection
    modelLabel: "生成モデル",
    modelHigh: "Gemini 3 Pro Image（高画質・課金必須）",
    modelFast: "Gemini 2.5 Flash Image（高速・無料枠あり）",
    modelHighDesc: "日本語テキスト向け。課金必須。",
    modelFastDesc: "英語テキスト向け。無料枠あり。",

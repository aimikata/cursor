...
export default function EditModal({ isOpen, onClose, originalImage, onImageUpdate, apiKey, selectedModel, onSuccess }: EditModalProps) {
  ...
  async function handleEdit() {
    ...
    try {
      let newImage = await editPageImage(originalImage, prompt, apiKey, selectedModel);

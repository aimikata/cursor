...
export default function Sidebar({ 
  ...
  }, [safePages, characterImages, pages]); // Added pages to dependency array
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-[10px] text-slate-500 px-1">
              ...
              {selectedModel === MODELS.HIGH_QUALITY ? t(lang, 'modelHighDesc') : t(lang, 'modelFastDesc')}
            </div>
        ...
        <div className={`rounded-lg p-3 border space-y-3 transition-colors ${isLimitReached ? 'bg-red-950/30 border-red-500/50' : 'bg-slate-900/50 border-slate-700/50'}`}>
            ...
            {hasCsv && pendingPagesCount > 0 && !isLimitReached && (
                <div className="mt-3 p-2 rounded border border-slate-700/50">
                    ...
                    {isBudgetMode ? (
                        ...
                        <div className="flex items-center gap-1 text-yellow-300 font-semibold text-xs">
                             <AlertCircle size={12} />
        ...
        <div className="bg-slate-900/50 rounded-lg p-4 text-sm text-slate-400 space-y-2 border border-slate-700/50">
          ...
          <ul className="list-disc pl-4 space-y-1 text-xs">
            ...
            <li>{t(lang, 'tip2')}</li>
            <li>{t(lang, 'tip3')}</li>
            <li className="text-blue-300/90">{t(lang, 'tip4')}</li>
          </ul>
        </div>
      </div>

...
4. **登場人物の厳密化（キャラブレ防止）**:
   * 主人公だけでなく、主要人物を**2〜4名**定義してください。
     - 必須: 家族（母 or 父 など）、同僚（職場の主要人物）
     - 任意: メンター（指導者）、ライバル/相棒
...
**Chapter 1: [章タイトル]**
* **マンガ**: [主人公の名前（${ctx.namingPolicy}に準拠）と、家族/同僚/メンター/ライバルを登場させてあらすじを記述]
* **解説**: [具体的な学習内容]
...
【主要登場人物（サブキャラクター）※2〜4名】
- 役割: 家族（母/父など）
  名前: [フルネーム（${ctx.namingPolicy}に準拠）]
  属性: [職業・立場]
  性格・背景: [関係性と動機がわかるディテール]
- 役割: 同僚（職場の主要人物）
  名前: [フルネーム（${ctx.namingPolicy}に準拠）]
  属性: [職業・立場]
  性格・背景: [関係性と動機がわかるディテール]
